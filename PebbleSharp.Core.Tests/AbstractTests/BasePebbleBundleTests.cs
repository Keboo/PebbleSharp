...
{
    public abstract class BasePebbleBundleTests
    {
        protected abstract IZip GetZip();

        public abstract void CanLoadInformationFromAppBundle();

        public abstract void CanLoadInformationFromFirmwareBundle();
